...
public class LetturadaFile {
	static String rot_path="//Users//carmineannunziata//Desktop//Progetto SI//rotori.txt";
	static String conf_path="//Users//carmineannunziata//Desktop//Progetto SI//configurazione.txt";
	String filename;
	int i=0;
	int p=0;
	int rot=0;
	...
	private boolean validateRotLine(String line, String prefix) {
		...
		{ if(line.length()!=ROTORI)
			{rot++;
			 System.out.println("\nFile rotori.txt non validato!");
			 System.out.println("\nIl rotore n " + rot + " contiene un num di caratteri più o meno di 26!");
			 return false;}
		  else
			{vett.clear();
			 rot++;
	...
	private String validateConfLine(String line) {
	...
	private static String[] configRotors(String path, String param) {
		int i=0;
		int j=0;
		int k=0;
	...
	public static void main(String[] args) {
		...
		String[] param=new String[n_par];
		String[] rotori=new String[n_rot];
		
		rot.readFile(rot_path);
		param=rot.readFile(conf_path);
		for(int i=0;i<n_par;i++)
		System.out.println(param[i]);
		
		
		
		rotori=configRotors(rot_path,param[0]);
